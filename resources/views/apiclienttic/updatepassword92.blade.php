...
<section class="content-header">
  ...
  <div class="col-md-12">
    ...
    <div class="card card-primary">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form id="quickForm" novalidate="novalidate" action="{{ url('/user/clientapi/prosesupdatepassword92/'.auth()->user()->id) }}" method="post">
        @csrf
        @method('PUT')
        <div class="card-body">
          <div class="form-group">
            <label for="exampleInputPassword1">Masukkan Password Lamaa</label>
