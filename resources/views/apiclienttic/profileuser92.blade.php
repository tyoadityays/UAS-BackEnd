                        ...
                        <div class="col-md-4">
                            <div class="card card-primary card-outline">
                                <div class="card-body box-profile">
                                    ...
                                    <form enctype='multipart/form-data' action="{{ url('/user/clientapi/uploadfotoprofil92/'.$detaildata92[0]['user']['id']) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body box-profile">
                                    ...
                                    <form enctype='multipart/form-data' action="{{ url('/user/clientapi/uploadfotoktp92/'.$detaildata92[0]['user']['id']) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="mt-3 form-group">
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="settings">
                                            <form class="form-horizontal" action="{{ url ('/user/clientapi/editprofileuser92/'.$detaildata92[0]['user']['id']) }}" method="POST">
                                                @csrf
                                                @method('PUT')
