                                ...
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        ...
                                        <img class="profile-user-img img-fluid" style="height: 100px; width:100px;"
                                            src="{{ url('foto/profil/') }}" alt="User profile picture">
                                    </div>
                                    <form enctype='multipart/form-data' action="{{ url('/uuploadfotoprofil92') }}" method="POST">
                                        @csrf
                                ...
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        ...
                                        <img class="profile-user-img img-fluid" style="height: 100px; width:150px;"
                                            src="{{ url('foto/ktp/') }}" alt="User profile picture">
                                    </div>
                                    <form enctype='multipart/form-data' action="{{ url('/uuploadfotoktp92') }}" method="POST">
                                        @csrf
                                        <div class="mt-3 form-group">
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="settings">
                                            <form class="form-horizontal" action="{{ url('/user/clientapi/prosesprofileuser92') }}" method="POST">
                                                @csrf
                                                <!-- @method('PUT') -->
