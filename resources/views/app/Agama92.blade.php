    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-6">
            <td>
                <a href="/adddataagama92"><button type="button" class="btn btn-block bg-gradient-primary btn-lg">Tambah Data Agama</button></a>
              </td>
            </div>
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    @foreach ($dataagama92 as $alldata)
                    <tr>
                        <td>{{ $alldata->id }}</td>
                        <td>{{ $alldata->nama_agama }}</td>
                        <td> 
