                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="name" class="form-control"
                                                            ...
                                                            value="{{ $detaildata92[0]->user->name }}" disabled>
                                                    </div>
                                                </div>                                           
                                                <div class="form-group row">
                                                    <label for="inputName"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="email" class="form-control"
                                                            ...
                                                            value="{{ $detaildata92[0]->user->email }}" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputName"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="alamat" class="form-control"
                                                            ...
                                                            value="{{ $detaildata92[0]->alamat }}" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputName"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="tempat" class="form-control"
                                                            ...
                                                            value="{{ $detaildata92[0]->tempat_lahir }}" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputName"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="date" name="tanggal" class="form-control"
                                                            ...
                                                            value="{{ $detaildata92[0]->tanggal_lahir }}" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputName"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="agama" class="form-control"
                                                            ...
                                                            value="{{ $detaildata92[0]->agama->nama_agama }}" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputName"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="umur" class="form-control"
                                                            ...
                                                            value="{{ $detaildata92[0]->umur }}" disabled>
                                                    </div>
                                                </div>
